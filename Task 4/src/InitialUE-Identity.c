...
static int
memb_ng_5G_S_TMBI_part1_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_ng_5G_S_TMBI_part1_constr_2 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_InitialUE_Identity_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct InitialUE_Identity, choice.ng_5G_S_TMBI_part1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ng_5G_S_TMBI_part1_constr_2,  memb_ng_5G_S_TMBI_part1_constraint_1 },
...
static const asn_TYPE_tag2member_t asn_MAP_InitialUE_Identity_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ng-5G-S-TMBI-part1 */
